...
if ($isWindows) {
  ...
  Start-Process -FilePath codesign -Wait -WorkingDirectory . -ArgumentList '-s','-','--force','--verbose','--deep','--no-strict','"./AmigaAdf/bin/Any CPU/Release/net8.0/osx-x64/publish/AmigaLha"'
  7z a AmigaTools-Mac-x64.zip "./AmigaAdf/bin/Any CPU/Release/net8.0/osx-x64/publish/AmigaAdf" -mx9
  7z a AmigaTools-Mac-x64.zip "./AmigaAdf/bin/Any CPU/Release/net8.0/osx-x64/publish/AmigaLha" -mx9
  ...
  Start-Process -FilePath codesign -Wait -WorkingDirectory . -ArgumentList '-s','-','--force','--verbose','--deep','--no-strict','"./AmigaAdf/bin/Any CPU/Release/net8.0/osx-arm64/publish/AmigaLha"'
  7z a AmigaTools-Mac-Arm.zip "./AmigaAdf/bin/Any CPU/Release/net8.0/osx-arm64/publish/AmigaAdf" -mx9
  7z a AmigaTools-Mac-Arm.zip "./AmigaAdf/bin/Any CPU/Release/net8.0/osx-arm64/publish/AmigaLha" -mx9
}
