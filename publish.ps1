...
if ($isWindows) {
  ...
  7z a AmigaTools-Windows.zip "./AmigaAdf/bin/Any CPU/Release/net6.0/win-x64/publish/AmigaAdf.exe" "./x64/api-ms-win-core-winrt-l1-1-0.dll" -mx9
  7z a AmigaTools-Windows.zip "./AmigaAdf/bin/Any CPU/Release/net6.0/win-x86/publish/AmigaAdf.exe" "./x86/api-ms-win-core-winrt-l1-1-0.dll" -mx9
} elseif ($isLinux) {
  ...
  7z a AmigaTools-Linux.tar "./AmigaAdf/bin/Any CPU/Release/net6.0/linux-x64/publish/AmigaAdf"
  ...
  Start-Process -FilePath codesign -Wait -WorkingDirectory . -ArgumentList '-s','-','--force','--verbose','--deep','--no-strict','"./AmigaAdf/bin/Any CPU/Release/net6.0/osx-x64/publish/AmigaAdf"'
  7z a AmigaAdf-Mac.zip "./AmigaAdf/bin/Any CPU/Release/net6.0/osx-x64/publish/AmigaAdf" -mx9
  Start-Process -FilePath codesign -Wait -WorkingDirectory . -ArgumentList '-s','-','--force','--verbose','--deep','--no-strict','"./AmigaAdf/bin/Any CPU/Release/net6.0/osx-arm64/publish/AmigaAdf"'
  7z a AmigaAdf-Mac.zip "./AmigaAdf/bin/Any CPU/Release/net6.0/osx-arm64/publish/AmigaAdf" -mx9
}
