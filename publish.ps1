...
if ($isWindows) {
  ...
  7z a AmigaTools-Windows-x64.zip "./AmigaAdf/bin/Any CPU/Release/net7.0/win-x64/publish/AmigaAdf.exe" "./x64/api-ms-win-core-winrt-l1-1-0.dll" -mx9
  7z a AmigaTools-Windows-x86.zip "./AmigaAdf/bin/Any CPU/Release/net7.0/win-x86/publish/AmigaAdf.exe" "./x86/api-ms-win-core-winrt-l1-1-0.dll" -mx9
} elseif ($isLinux) {
